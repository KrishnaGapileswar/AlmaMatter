...
<body>
	...
	<div id="ac-wrapper">
  		<div id="popup">
  		<center>
    		<h2>Alumni Meet on June 3</h2>
      		<input type="submit" name="submit" value="Okay" onClick="PopUp()" />
  		</center>
  		</div>
	</div>
	<!-- company logo -->
			...
			<div class="navbar-header">
   			...
   			<div class="collapse navbar-collapse" id="myNavbar">
     			...
     			<ul class="nav navbar-nav navbar-right">
       				<li><a href="https://pavbschool.almaconnect.com/"><span class="glyphicon glyphicon-user"></span>Register</a></li>
